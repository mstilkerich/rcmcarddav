...
ALTER TABLE TABLE_PREFIXcarddav_contacts MODIFY COLUMN `uri` VARCHAR(4095) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

ALTER TABLE TABLE_PREFIXcarddav_groups MODIFY COLUMN `vcard` LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE TABLE_PREFIXcarddav_groups MODIFY COLUMN `uri` VARCHAR(4095) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
